...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://postgres:root@127.0.0.1:5432/simspro")
}
...
MIGRATION_MODULES = {"sites": "simspro.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "simspro.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Chucknorris Garikayi Madamombe""", "chuck.self@chuckygari.com")]
