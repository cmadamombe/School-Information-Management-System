...
class ParentsAdmin(admin.ModelAdmin):
    fieldsets = (
        ('Parents Personal Details:', {  # The first fieldset is named “Parents personal details”
            'description': "Please capture the parents personal details: ",  # The first option sets the description for the group
            ...
            'fields': (("user","title"), ("date_of_birth"), ("parent_phone"), ("designation", "date_of_joining", "gender"), ("religion", "language", "nationality"), ("marital_status", "profile_image", "qualification"))
        }),
        ...
        ('Physical Address & Profile Summary:', {  # The second fieldset/group
            ...
            'classes': ('collapse',), #Adds the collapse class to the fieldset. This will apply a JavaScipt accordion style that will make the fieldset appear collapsed when the form first displays
            'fields': ("address", "parent_profile_summary")
        }),
    ...
    list_display = ["user", "p_id", "parent_phone", "gender", "created_by", "created_date", "modified_by", "modified_date"]
    #The fields that will be used to search the database
    search_fields = ["user","p_id"]
