...
class EmployeeUpdateForm(ModelForm): #UserUpdateForm class inherits from ModelForm.
        ...
        employee_number = forms.CharField(required=False, disabled=True)
        ...
        teacher_profile_summary = forms.CharField(required=True, disabled=False, widget=forms.Textarea(attrs={'rows': 2, 'cols': 6}))
